                ...
                <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-3 text-balance">
                    {process.env.NEXT_PUBLIC_ENV === 'production' ? (
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <input type="password" {...register("password1", { required: false })} placeholder="Current password" className="w-full h-11 bg-[rgba(73,73,73,.56)] rounded text-white text-center outline-[#C67E5F] focus:outline focus:caret-white" />
                        </div>
                    )}
