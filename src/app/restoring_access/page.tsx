...
export default function SendRequest() {
    ...
    return (
        <div className={`relative h-[100vh] w-full bg-[url('/signup/bg-signup.png')] flex justify-center items-center object-cover bg-cover bg-center bg-no-repeat overflow-hidden text-white ${MainFont.className}`}>
            <motion.div
                initial={{ opacity: 1 }}
