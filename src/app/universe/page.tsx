                    ...
                    >
                        <div className="flex flex-col items-center gap-4">
                            ...
                            <div className="flex flex-col items-center gap-3">
                                ...
                                <Link href={'/universe/add_universe'} className={`flex flex-row items-center justify-end gap-2 uppercase text-xl py-2 px-4 text-white text-center rounded hover:bg-[#C2724F] transition duration-150 ease-in-out ${userRole === 'admin' ? '' : 'hidden'} `}>
                                    add territory
                                </Link>
                            </div>
